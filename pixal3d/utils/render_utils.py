...
from ..representations import Mesh, Voxel, MeshWithPbrMaterial, MeshWithVoxel, MeshWithVertexPbr, MeshWithFacePbr
...
def get_renderer(sample, **kwargs):
    if isinstance(sample, (MeshWithPbrMaterial, MeshWithVoxel, MeshWithVertexPbr, MeshWithFacePbr)):
